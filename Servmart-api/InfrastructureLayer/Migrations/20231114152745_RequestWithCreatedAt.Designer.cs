...
namespace Application_Layer.Migrations
{
    ...
    [Migration("20231114152745_RequestWithCreatedAt")]
    partial class RequestWithCreatedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("278326ec-1c30-404e-ad56-5604a1dc4c27"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("2d3e0ced-df00-47df-8ac6-eb96477a1903"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("99948c39-9b88-4cba-8012-fb727d485173"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("2cd8bb2b-a9e7-4592-9a4d-70ecd752ec73"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("885e2ea7-4ed4-438f-a3c6-b0e0aee3a4fe"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("63019f1f-550a-42d5-a41d-6c4bedf4d9ee"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("de44bd79-4fc4-4d1a-a01f-5349e7bb09d9"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("29cd209d-1b42-4933-bd5d-9845bb8a6730"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("aeed867e-ec87-4bfa-9ccf-82f1b35ea28a"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("bb057a55-fdde-4ca3-a424-050623a8c760"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("f9c54ae6-1b4c-4581-93f7-fbcd8d3a68c7"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("196f94b1-a789-4cbf-af4d-ec0e0fc4da73"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("1a9d8b31-899e-42ac-b4ab-1734be6a3002"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("a2483bdd-8157-4e93-85ee-c230a847f231"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("a27768ca-e8f4-4a7e-a429-1c02a8cd6281"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("41f6b5c1-b8b2-411a-8080-7473ddbe6911"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("2864443b-b5b5-43e2-85a8-2c15d4362c3b"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("c86545e4-dae8-4e43-8872-cc6f5a97e2b7"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("27329da7-7461-45fb-92e0-6e655f4f0fe3"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("bc6af618-ee2c-4e33-86ca-6821cce523ab"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("fa4940bc-4bc5-4bbe-9589-146220e1a9f6"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("48e542df-ad0c-4fbb-b82f-14800983af81"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("29ec9b10-0e6a-491a-8dd5-5294f47ed508"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("955bd1bf-b437-4ffa-a316-ab2519d47d12"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("460990a0-c9d9-46f1-888d-dc6a7bb8dc3b"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("9aa9f0f6-d2e7-4965-9549-8fdbd62d61cb"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("a0c47d73-742f-4683-a2ff-67f2f5383953"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("22b6eb9b-58bf-409f-bd8c-04ae0706fcc5"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("7ab2e85a-502f-42c1-bf0a-43d2c6773130"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("bb4995d3-5d50-4098-b914-ce0c21709094"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("9bd85579-7d18-4111-8d7e-b9227bbddb95"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("3d4643c7-4051-42bc-b372-05b280dff04f"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("e4b334fe-0853-4ac5-981a-8848d4577b76"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("c448c2d8-5814-4e41-abd8-f01f327923d3"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("f5796197-4e85-492f-aaa1-b9028f73dd27"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("2d2df455-be9f-4479-b21d-78e07ba4235b"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("51c8ec4d-0705-46f2-ba5e-03fd767b46af"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("f436968f-d824-4140-be3b-f9f5ac7f9076"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("32f97b4e-997b-42a5-9b4d-86f921f43ba2"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("054f148b-f838-4732-9de2-bcc7d91aa473"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("dbb1141b-d858-4782-8232-014779be5d11"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("804d90de-7c04-4503-8bbf-53093510bf8f"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("0ba193d8-eda2-488c-ab2c-b1a60ff98f35"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("1622e8d8-3b3b-46c9-8663-2c9b8037441b"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("98831f1c-34ad-4b21-b6a3-b1016ae8fcbd"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("65273839-e0cb-44e7-b7ea-67cffe0ea030"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("7c5640d9-f3ff-477a-8348-6682eec1a3b8"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("3b2bf177-0142-42ed-b407-01ced9f05a0f"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "43decfa9-e3c4-4968-ac1a-fbca3a314e97",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "66d4eb80-2196-4cff-b0bf-8d6cb88825a2",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "3804066a-8b89-4c4f-87df-fd6aaccc52e9",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "eadcf9f0-75e8-4981-b3ef-91c19756ff42",
