            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("fd878e7f-5afa-468f-ae80-5146a0216463"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("973db0a6-5078-48fa-b111-da6fdb28914b"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("3103ffd1-520f-4d15-a07b-4442fe84c7f4"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("6d5c2de4-3192-4681-b320-96c1b64cb326"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("a469b571-eee3-47f1-94cb-aa60fb76e339"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("344d6c7d-7dbc-48a5-9250-eb95c3a540d1"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("6503c8d5-77d1-48ff-b060-2694e96683e6"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("e796d4ff-3ea9-4f7b-be47-997e1c88c687"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("0795aff2-73bc-4542-bdbf-eab436a98bac"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("db5ecc40-a259-49f9-940f-a34fc823ae4a"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("21c9c8bc-eee9-4c10-8c2d-6304dbdba63d"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("6378dfc0-72d3-49f2-a56d-8ff9f2bf6079"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("ba6fbd78-b016-4679-b8cc-212eec6ffb75"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("1aea3da0-bef9-46e2-a624-0e224d70fa8b"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("8ced543c-a049-457e-9032-811fcccb5a69"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("9531ff3e-8b38-4ae7-9481-9d1ac4d9940e"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("281397d6-0b07-41d6-b26b-e4c3cf81cec5"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("e59b4d36-f506-40c0-90f3-875355904cab"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("725ae7ed-49c9-4243-8a5f-0a79b224608c"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("85e8eed0-3626-41c5-8cb0-84052f51b31d"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("9afc7081-3e5c-4a81-8887-6b6ed050e433"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("1c5615e4-c005-46ef-b100-b289a4638b3a"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("31b6e294-28ef-404d-8315-ed63d4f31fc7"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("0424a710-cb80-4a0b-bdd8-9a61a7622f86"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("9ac07845-e55d-4c69-8fbc-486ef8e30c7d"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("ef053846-3143-4a08-8461-f1e242ff9c12"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("b21c75ce-3860-46f5-b2ac-28f308ab344a"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("8cb2285e-618f-4494-853e-e93f9dae42d0"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("2e62c9a2-cdb5-4bf9-9098-b5c0521a41c6"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("7f4f7877-1bd4-44ab-afe3-1b576e960638"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("dcf1a12a-f935-40ee-b852-ffe538ccd470"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("be02352c-bc95-406b-b1d3-e0dc5510c6ee"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("362043f3-4439-4564-ae88-ec65ae716004"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("b9ea6a34-37d9-4e19-b74d-c21c7ef3bccb"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("c841fd75-bcb0-426d-97b2-e78e23bc9eba"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("3bcab41c-db35-4ed0-a054-50afb5e30ff6"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("d2c84016-2e22-4657-94cb-bf734ebfcf18"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("b137b664-b358-4aba-8149-3c3c5273ea77"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("7267cf2e-09a0-4c00-83c4-015bf87ed2ed"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("2ebe07d1-7e56-4d85-bfdc-24396cc7796b"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("4e11eb23-5e57-4bb3-bcab-fe851aaf2a6e"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("8f07b8e8-0c1e-4204-98f6-4458a1c2832f"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("d5b8a086-e5e4-4b7d-82b4-8e4b5a8c44e9"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("32706a9a-9bb9-4830-8249-0428d76e852f"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("9249f611-f473-4e3b-879f-608f39bf7c62"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("2fb55c30-a4f4-432e-9da3-f80dd1fa2854"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("cbeeb638-bf68-478e-b26c-b1dcad48bc3a"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("63ffa90c-ae1f-4274-a3db-0be7f8d3f974"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2f6404ae-3362-487b-a2ce-c5c67b795f91",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e0a6f241-12b1-423d-95be-ab4e0d327bc7",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "5a9a37ee-347d-4fdd-a1c4-77352182dd11",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "661f57df-d50f-4034-aa87-6bc0829cf667",
