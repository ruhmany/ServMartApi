...
namespace Application_Layer.Migrations
{
    ...
    [Migration("20231109110234_initailCreate")]
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("ed639b6e-ba4c-4d17-8a6c-c2ce2ccc1980"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("24c5d132-a645-4f93-beb3-e09c7e376599"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("d857c947-6c8e-43cf-9810-ad1fc5dcc09b"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("072f8b38-df15-4f0d-9bb0-3c322597659e"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("9201c348-b1bd-4c87-a713-96dffd783969"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("711c9745-5c78-43b1-b0c0-3db2f24e6b45"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("d30aa20d-cd46-433e-a58b-d6d868361862"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("d3fc95f1-f2a2-4ff4-b7d5-7e26f07af832"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("3dbf1f2a-2aa9-43a5-98ba-9c1dd965cf76"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("65e863c7-3cd8-4684-9ec8-5a302b87a4d4"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("c354fad8-66eb-4d67-9078-a64f826266ec"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("9af536a2-6da8-427c-86f5-425e32959eca"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("2bc01b8a-44bb-40f3-af78-1cf5745d84be"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("bdd09a87-b380-4ad2-8b14-c040662e7942"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("1687e5ce-74ba-4e18-b983-9d46a50b22ba"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("780df81d-c803-4393-9597-63f42654771f"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("c3db72b6-56d7-4970-97ed-f496fb7bd142"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("ad94427c-8a24-428d-aaac-3b8a082c556d"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("d073f4ce-3e15-4ca8-825c-7499d47ca7db"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("4b84ea6f-b13f-40fe-b30b-9054aa4e1b46"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("22fed7dc-06ed-490a-b283-26d0cbc47856"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("a237f048-7705-4be1-b9b1-a28f44251b28"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("f42319f4-cab2-4bf2-a033-ed12a0d165ca"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("2c98c046-773a-4160-889b-2f5307458bbc"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("b254524c-4929-4595-994f-c087070f9957"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("2128baaa-2310-4cc3-b3a8-818fe094922f"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("09a5b00d-98bc-44e4-b763-10365f424b65"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("57213f39-9b0c-4448-b4b4-07f967d3ade3"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("473c38b7-d512-4099-99c4-00ab0ded5f69"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("25175465-c915-4ae3-bbfb-ff4b9b9d890b"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("5eee76e1-aa12-48c5-84f7-27951986ccef"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("578ec31a-e8cc-469d-aaa5-16a6ee3b8a80"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("34279a13-65cc-4bd7-a206-8ad203331132"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("db1daeac-0cb6-4fb7-98b8-e8add9732fd8"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("05577694-5e88-4580-adb7-b507d041a768"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("eb592ead-ea9a-4f1f-9dc1-55ff27b562d6"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("c5cbd767-6af6-464e-8130-dfc19219833e"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("d578d549-af29-4118-b110-ef47f340de91"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("6d7e1fb7-83bd-4af2-abae-9c6e49b9ae12"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("7978c709-9d84-4624-bbc2-9a35d396cfa7"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("0e3d87c6-7b08-491d-b955-aace20a79b47"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("5dc3f9b7-c953-46b1-ad55-f4c6dce828dd"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("cd6b1db3-fc8c-4203-b655-222585778b22"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("e7d2b0ea-7b28-486e-b714-c145ddce90fa"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("1f8e083c-171c-4209-8e50-0e1ed1505a7b"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("71e8d611-8d88-4f3d-add2-331dcc699de6"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("37d42ead-6640-4faf-a85d-ad31079f58f8"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("7afbaefb-9460-4d64-b453-37a13c9c370c"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "20e6e0e3-1ab3-4dc4-848c-385da4479e4e",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "af7b2705-e605-4f54-bc9f-8576de22fd1d",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "7a6bc53b-36b8-46f6-bf8c-fc78c5c99927",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "f4366997-79f1-4c28-9dc2-e13b407d5908",
