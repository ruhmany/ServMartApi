...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20231108201833_intity")]
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e6b2c120-a081-4b18-bb26-1edec8a0e9ee"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("ef3cf33d-0473-4ff1-a7fe-a01de4343401"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("237dd9d0-7272-42de-8906-fa7ef0c8f3be"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("e568f495-d873-4ef7-b85e-0c9a54a8f699"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("5847e6ad-d6b9-4076-b9bd-077a046b28e3"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("15263ad1-4909-4e62-ad5f-e826c0baefaa"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("7866ef4d-3518-449e-a4bc-3a2927522646"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("8c63ac3c-eab6-4885-8f1d-9492ba665182"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("645a439e-05aa-4fc4-b4b1-f35c7393e2c4"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("7f8788a6-eb19-44b5-a15f-42d57bce8dd4"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("aa096c4c-d15f-4332-a69f-df4b078868dc"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("0375b579-8c3c-46fe-a688-8cec771e1390"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("1807267a-e421-49e0-9513-bba3aa1a91e3"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("5f4353bb-180a-4104-b0f6-1a1a9a668e53"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("06d71b51-1db3-4c5c-8426-75f1d5b3057d"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("f7d57ab1-71f7-463f-850d-d48bf27589aa"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("55ff3b21-d533-4dff-8a96-5e8f5c4c5ff1"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("9eeb483f-5f63-4e6f-bd33-26e64f9172d8"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("ff81201b-fc2c-48f1-9e69-b7a7b392d3a7"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("df658c50-410a-4c0b-a5a3-65f214b3d75a"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("b9de7b73-9f78-49e1-8a62-bfd53094a13e"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("89ffa741-39b5-472d-a3e4-f0dcddb32edf"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("41363fe6-60fc-446a-8e84-02c622a000fd"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("078559c5-9ea5-4e7a-b144-904eab54c76a"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("6d43aee6-6c52-469f-a059-f00faa9869cf"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("b817d9f9-8842-4a27-94a1-9fb7264b5b7f"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("158cee74-3a77-4b16-aff7-63608a34f2b0"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("4f4e9752-346e-49d1-9e00-e51a65d13028"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("44972479-d2a9-434f-a783-40b8ca3cfb21"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("3ca5e4c3-ea56-4ba6-83ad-e0f6dcdd07e3"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("d21a77ec-8965-412e-a813-585dd95da802"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("d2bbaafd-f286-4c5e-920f-0ebc7baf9aa7"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("b4f68536-ff8d-4944-8538-238cda937d22"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("3e6167a4-ebe1-440d-9b7a-80100e3fdbda"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("6981cb78-2c48-448f-9253-e55a1ced2d74"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("ef3e92f9-9814-436e-ae8b-c112bbb48d37"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("54fafdbe-b6c4-4965-af22-5c6c42d96208"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("87bb2bb5-0d3f-44a7-8823-91927333f0fa"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("facdaec9-6714-4f96-a906-dfe46cc16c1f"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("b2670c2c-c0a0-42cd-843d-d6580411d460"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("ac7352c7-a070-46f6-87a1-8f69f839beff"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("c2c9e0d5-fe3b-4029-b6e7-5abdfa771e03"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("7abe39ae-7138-4541-a9c5-70c9582d7528"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("bcbe4fd7-60d6-4dcb-a955-ea73216378b1"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("f1bd7218-dc92-487f-9b09-262a3129e323"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("dda53ad8-e389-4158-aa29-3d5b66798f95"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("124fcd15-4eb1-477c-adb7-646ca0e4ac39"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("b0b9c904-33e4-4484-a789-a8c3e8c30ce3"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "43cd27dd-23dc-4d50-bf95-cd3912fd48e5",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "40f860d2-97c3-4292-aa6c-f18351a1617d",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "543814fc-1815-43e1-8e47-c03400dae9de",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "469bf326-601b-43c4-a56b-d2072c8df978",
