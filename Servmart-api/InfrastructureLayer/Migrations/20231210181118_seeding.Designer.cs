...
namespace Application_Layer.Migrations
{
    ...
    [Migration("20231210181118_seeding")]
            ...
            modelBuilder.Entity("Domain_Layer.Models.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("a0e36702-5873-4d15-b10d-ae8cb81b463f"),
                            Catagory = "ملابس "
                        },
                        new
                        {
                            ID = new Guid("bfe5434f-f8bb-4783-b2fb-d5b11504c595"),
                            Catagory = "لحوم"
                        },
                        new
                        {
                            ID = new Guid("416a1e59-fb65-47ec-a955-2c0c9ee8e33c"),
                            Catagory = "مياه  "
                        });
                });
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e038aee1-6683-497d-b299-7b9a446ac8bb"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("48803309-a9da-4064-bad1-8c33f406a793"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("11d19870-6146-4af1-a8fe-48a43c8c0927"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("879ceba0-8fd0-410b-b7db-4439494f433b"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("8bfd4787-46c7-478f-8d50-1364b335a239"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("3d5f12b4-4e4c-4e29-b85a-c47b1b6df508"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("eb534de8-4c7a-422c-aeec-02bbdfef1802"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("67c2c4ea-b67e-49c7-9aca-a11a3be6cc39"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("bd3e74ef-12c5-458c-a4d4-54a87afbbbaa"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("ecffbdf5-8c6e-4faf-8887-6f316cec519b"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("6e57cd69-b752-431a-89bc-3c15deaf82ac"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("ca3974bb-db89-479b-80ef-561acee98eb0"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("d778c036-7fd1-49ca-822f-94a07fb177fb"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("5cd4b119-12d0-4c43-ba0c-c0114732acad"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("de9b8694-eb6c-415c-8eb6-363bb4089b3b"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("9db783cc-2d05-4baa-966d-3078e61a2966"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("0f00c014-5788-408b-9e30-a21f2c99d4f7"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("1c9facc8-a4f2-48d5-90f9-6153691b3ccf"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("c83a4a3c-7217-45db-80b0-96133ea34192"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("5f197995-b187-461a-a031-e0e1d02a21ba"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("7b98b25f-3956-4fd8-bdbb-5da9ef357e5b"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("66698567-cc04-47eb-b1b3-cb613fb198e7"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("cf97b3e3-1622-4bde-bae8-7371fd195258"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("371e8375-2745-4a24-8960-8b005637b09f"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("41b96260-880a-46b0-b28d-aa3b80a8a019"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("d859f8cc-8b6f-48db-889c-45bdf7eb528c"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("8bb3a925-f753-4177-aab7-a64d494eb390"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("170e6f93-6b2e-4477-8ad5-d9ff457e7c74"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("486b2469-3e2b-45e8-880a-e178642d3a88"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("7ece3e3d-a96d-454c-8e86-0c38e904377c"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("0a956bcf-89ad-4bbe-a545-6ca0d8baa9b3"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("06f95bb3-31c7-4d60-9428-7e3c2a59dfb7"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("c72bdf13-7e27-40f6-8bfb-4f5dfac10edd"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("643f3358-e691-4a6b-908d-9be55b6098b5"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("2e8a860f-3ae3-4345-b0a7-be5d1bc18c62"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("94c6a34d-8bdb-496c-9dce-751685064a34"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("18ac4108-5d34-4218-b37b-a86b798e6b7a"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("8f0c1896-6ae2-418e-ab96-c72c4decc3c5"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("63a59ece-15b2-419c-913e-7b65b5ee63a6"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("95e0b6c4-9750-46dd-a836-99ca85844b4d"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("58557d79-d90b-4360-baef-77585e997e56"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("effefb0a-1e59-4b62-85a4-8534343c905b"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("3b6b2649-8b5d-4707-a89b-285e3da1f82a"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("1e0d364d-f6ac-44ec-9aa4-e9eafbf20aa1"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("70bbf2ee-e5ec-4ba2-ac97-4dcbd22d055a"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("78c31345-9bdd-46df-bf3a-adc7815eabf0"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("4246951b-9b8a-4b0e-87d5-fd5baa06ec0e"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("2ae1e529-d81b-4314-9b7f-2233b2f15daf"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "351e55e7-0526-48e8-ae14-5660bf248ca4",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "471f823f-f19d-4c7d-bc8d-4746fe078121",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "4578be63-9097-4066-9e38-2f5ace098a06",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "b627e5ac-882a-4984-9242-e5e52e201cc0",
