...
namespace Application_Layer.Migrations
{
    ...
    [Migration("20231205145523_UpdateRatingTables")]
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("816a5a2d-bc5b-4153-87c0-a33f8ad5d4eb"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("55dcf1e2-29df-4454-94ef-ad8d160a170b"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("99c5572a-2f10-443b-b97e-2bed8a4d4ffa"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("e7c60c33-1abd-43f3-b009-3a8d7f0efa5f"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("7e4c054b-61dd-4f34-9b81-778a8195b3f0"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("f55836be-843b-49fa-ae2e-e0a0327142fe"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("415ea623-6fbe-408b-bb77-4f05c4e5081e"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("4c7df3eb-aae0-4a08-a14e-46c1f8e85fc8"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("c6bc50a0-e989-42c5-b04b-71650e092177"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("5e91d996-6161-4c64-8293-21e237253a54"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("1211439d-6595-445f-9769-da6bb9c6190f"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("b43fbea8-b3b6-4e8b-bf24-838067ebf7c8"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("73726bd3-32cf-445f-bd41-b19c160ce971"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("fbf91da4-f8d6-4052-bbae-622184107190"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("6703c50b-e02b-4099-942e-2d441c45766b"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("b7b65876-ab6c-4914-be73-a8427d802101"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("1a4c266f-e63f-49c6-8ea4-09f49ae78517"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("9c9df342-8974-42fa-9149-eb17101f522a"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("c1436b13-d1c8-4227-b49a-f2135c2e56b4"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("bbcc5141-6297-414b-8547-b8eff163b3e3"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("dfe93772-70e7-4d04-8d24-90a45f413172"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("1d3a7885-03ce-4ec2-87c1-160f5f4f61f4"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("d1506e47-c32b-48e9-8e56-2ee19749606a"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("43eeac62-b5eb-419e-9db8-13daca7c3339"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("d6293e2b-7667-4427-ac7f-b402a8917536"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("d6000dbd-6b4b-4971-b97f-59e7dafba699"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("0818bf43-1fcd-4520-b283-cee706a31707"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("6b8bd2c1-b794-44e0-bfb0-7851e2d62512"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("27987ddb-1abc-4013-9889-412463da1b81"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("05335794-ffa9-45dd-af2a-e9d0a7689edc"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("1a43a534-aaa0-4e80-b873-0b87efbc35b4"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("8259fa1c-7830-4240-bcf9-f226f23e4e89"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("751ca285-ce37-4b63-b642-1d12327f685b"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("dcdbc193-bc1c-41f1-b130-979fd577a448"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("bb509e58-fbb0-4342-ab44-0e6bdf74c82e"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("063dd24b-cd27-4b28-bb70-9fba172adc84"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("7826fad4-9c6b-46a1-8e0a-a6736e80a4e5"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("10ba11c5-5a2f-4fd0-8eae-2bda71b82b80"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("ef23916b-0a2a-4c72-8260-7d93a99b8dc4"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("1e1e7a96-819b-4c94-9037-d8678eb4e8c4"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("847733ff-6200-4cb4-ae1e-23e3a6285b58"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("8eea7039-8499-40be-ab96-38da857aea69"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("aa0c7ccf-d92b-49d2-a0be-6b0e69109401"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("d354fae9-ab23-4b4a-94ab-73de66054a2a"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("6db72198-b53c-432b-ad08-831c232e487b"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("c9d21ace-1dc5-4494-9897-141f53edb873"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("29768473-0e7f-42a1-b5a1-f7aabcc9f683"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("47666ef0-4697-4a18-a21c-5832460c571a"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6ba121f5-930d-4aca-ad15-fcdcffd997cc",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "316aecff-8125-42ba-a688-4407bc9b1ca0",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "c31f9de8-4187-4eb6-aae9-dee791c31ef9",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "9c0cb018-d170-46d8-b845-b814c6b6e39a",
