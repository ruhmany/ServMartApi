...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20231107170651_updatedRequest")]
            ...
            modelBuilder.Entity("Domain_Layer.Models.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6a7ff909-c548-46bf-a276-c180114525ff"),
                            NameAr = "المحاسبة",
                            NameEn = "Accounting"
                        },
                        new
                        {
                            ID = new Guid("a038c51d-46b4-4672-a67a-413ba0b636ee"),
                            NameAr = "الإعلان والتسويق",
                            NameEn = "Advertising and marketing"
                        },
                        new
                        {
                            ID = new Guid("5cbc79b6-a63a-40b6-87be-f0de7a24d6ea"),
                            NameAr = "إستشارات",
                            NameEn = "Consulting "
                        },
                        new
                        {
                            ID = new Guid("ad57f44a-00ed-4b66-acb5-4d8ce0e5fa06"),
                            NameAr = "خدمات تكنولوجيا المعلومات",
                            NameEn = "Information technology services"
                        },
                        new
                        {
                            ID = new Guid("1e61d5e6-7c5f-4738-93ff-fb7cece71c8d"),
                            NameAr = "خدمات قانونية",
                            NameEn = "Legal services"
                        },
                        new
                        {
                            ID = new Guid("de129eff-2aff-4173-8523-bd653adecd2b"),
                            NameAr = "إدارة المكاتب",
                            NameEn = "Office management"
                        },
                        new
                        {
                            ID = new Guid("0a5c10eb-2326-4e4f-9404-ff5b77a0e110"),
                            NameAr = "خدمات الترجمة",
                            NameEn = "Translation services"
                        },
                        new
                        {
                            ID = new Guid("9e79e1d2-3e54-4bc0-b6cd-a225af6545d0"),
                            NameAr = "تصميم وتطوير مواقع الويب",
                            NameEn = "Web design and development"
                        },
                        new
                        {
                            ID = new Guid("b34a83a4-81a5-49d2-af57-5b18d30b8b73"),
                            NameAr = "صيانة سيارات",
                            NameEn = "Car maintenance"
                        },
                        new
                        {
                            ID = new Guid("3bbbcd2c-9280-4ad9-a950-8e4da5795a0b"),
                            NameAr = "خدمات التجميل",
                            NameEn = "Beauty services"
                        },
                        new
                        {
                            ID = new Guid("ce6d82c4-e7f8-44ee-86d6-bb2280e44b6a"),
                            NameAr = "تقديم الطعام",
                            NameEn = "Catering "
                        },
                        new
                        {
                            ID = new Guid("4f1a6361-a73b-4869-b30b-1c340fe9eabe"),
                            NameAr = "رعاية الأطفال",
                            NameEn = "Childcare"
                        },
                        new
                        {
                            ID = new Guid("0cc654d5-fc03-44f3-bea8-17a48682a26d"),
                            NameAr = "خدمات التنظيف",
                            NameEn = "Cleaning services"
                        },
                        new
                        {
                            ID = new Guid("80ae1157-9edd-40c3-a458-1d6de21aad22"),
                            NameAr = "إصلاح الكمبيوتر",
                            NameEn = "Computer repair"
                        },
                        new
                        {
                            ID = new Guid("bc0aaae3-443b-4e45-a407-3d76a779c85d"),
                            NameAr = "خدمات التوصيل",
                            NameEn = "Delivery services"
                        },
                        new
                        {
                            ID = new Guid("6989d5e7-4e70-466d-b107-f0bb667001e5"),
                            NameAr = "التنظيف الجاف",
                            NameEn = "Dry cleaning"
                        },
                        new
                        {
                            ID = new Guid("eaa3bc9c-d980-4787-aa3b-71cc1a3dbebf"),
                            NameAr = "التخطيط للأحداث",
                            NameEn = "Event planning"
                        },
                        new
                        {
                            ID = new Guid("b8c79184-2e40-4c3c-a542-efa76f4db010"),
                            NameAr = "الخدمات المالية",
                            NameEn = "Financial services"
                        },
                        new
                        {
                            ID = new Guid("b07d0e5a-e15e-499c-ad3c-904a5f1a5f23"),
                            NameAr = "تدريب اللياقة البدنية",
                            NameEn = "Fitness training"
                        },
                        new
                        {
                            ID = new Guid("f140e04b-12ee-4ec5-93fa-f8149f4db939"),
                            NameAr = "توصيل طلبات الطعام",
                            NameEn = "Food delivery"
                        },
                        new
                        {
                            ID = new Guid("89b866bb-59f3-4169-8881-3f1c5eca5476"),
                            NameAr = "تأمين",
                            NameEn = "Insurance"
                        },
                        new
                        {
                            ID = new Guid("21293c58-8978-4acd-8b55-77d129670e3b"),
                            NameAr = "العناية بالحديقة",
                            NameEn = "Garden care"
                        },
                        new
                        {
                            ID = new Guid("d41ad544-f57e-4e48-ba22-e8a430f54b76"),
                            NameAr = "خدمات غسيل الملابس",
                            NameEn = "Laundry services"
                        },
                        new
                        {
                            ID = new Guid("4f8e2433-f937-4c19-b01d-001bfc72561e"),
                            NameAr = "خدمات صناعة الأقفال",
                            NameEn = "Locksmith services"
                        },
                        new
                        {
                            ID = new Guid("0f1af7b4-87f2-43d0-9a93-521f4046154e"),
                            NameAr = "الخدمات الطبية",
                            NameEn = "Medical services"
                        },
                        new
                        {
                            ID = new Guid("0cfa0d39-d73d-45d3-a246-1eb79a26b84f"),
                            NameAr = "خدمات النقل",
                            NameEn = "Transportation services"
                        },
                        new
                        {
                            ID = new Guid("be21c433-2b2a-47cd-8f1f-0df0e5f7d68c"),
                            NameAr = "رعاية الحيوانات الاليفة",
                            NameEn = "Pet care"
                        },
                        new
                        {
                            ID = new Guid("42935cf9-8039-4977-80f5-e5c12461833d"),
                            NameAr = "الخدمات البيطرية",
                            NameEn = "Veterinary services"
                        },
                        new
                        {
                            ID = new Guid("0adb3e59-8089-4b9e-9d75-6742f22bca4c"),
                            NameAr = "سباكة",
                            NameEn = "Plumbing"
                        },
                        new
                        {
                            ID = new Guid("73790c1c-84dd-4baa-be5d-e2196b738914"),
                            NameAr = "كهرباء",
                            NameEn = "Electricity"
                        },
                        new
                        {
                            ID = new Guid("eb47d258-1b98-47fc-b9b5-a60d2f82d34d"),
                            NameAr = "نجارة",
                            NameEn = "Carpenter "
                        },
                        new
                        {
                            ID = new Guid("3119e8c4-8a65-458f-a3f4-c31dd82569e4"),
                            NameAr = "نقاشة",
                            NameEn = "Painter"
                        },
                        new
                        {
                            ID = new Guid("0bafff88-b191-44df-a1bd-0ced7efaa464"),
                            NameAr = "مكافحة الحشرات والطيور",
                            NameEn = "Pest and bird control"
                        },
                        new
                        {
                            ID = new Guid("293b6620-10e0-433a-a2b4-6994f85d4a3b"),
                            NameAr = "ساتلايت ورسيفر",
                            NameEn = "Satellite and receiver"
                        },
                        new
                        {
                            ID = new Guid("dcf11a46-26a1-489e-a02c-920ae33fb949"),
                            NameAr = "التكييف",
                            NameEn = "Air conditioning"
                        },
                        new
                        {
                            ID = new Guid("93e1c242-cdfb-44f3-b87d-bb2580464b49"),
                            NameAr = "تركيب و صيانة الاجهزة المنزلية",
                            NameEn = "Installation and maintenance of home appliances"
                        },
                        new
                        {
                            ID = new Guid("34e32c40-7739-457b-b347-113a916ded61"),
                            NameAr = "تنظيف حمام السباحة",
                            NameEn = "Swimming pool cleaning"
                        },
                        new
                        {
                            ID = new Guid("f9eead7d-8785-4242-9b23-20fb348736d4"),
                            NameAr = "تسقيف",
                            NameEn = "Roofing"
                        },
                        new
                        {
                            ID = new Guid("dc2353de-8b7f-4fd1-ad76-9837a5a069e2"),
                            NameAr = "خدمات سيارات الأجرة",
                            NameEn = "Taxi services"
                        },
                        new
                        {
                            ID = new Guid("b3fc05a6-8549-4d8c-a040-e9560339bdb0"),
                            NameAr = "خدمات حكومية",
                            NameEn = "Government services"
                        },
                        new
                        {
                            ID = new Guid("ae7c336f-050a-43af-9d8b-6c95df3b7e49"),
                            NameAr = "المكتبات",
                            NameEn = "Libraries"
                        },
                        new
                        {
                            ID = new Guid("09e37b91-61ed-4361-8ac6-47adfaf09769"),
                            NameAr = "حدائق و منتجعات ترفيهيه",
                            NameEn = "Parks and recreation"
                        },
                        new
                        {
                            ID = new Guid("996954c1-e0d7-4bb8-8a61-19fb724688cd"),
                            NameAr = "ترفيه",
                            NameEn = "Entertainment"
                        },
                        new
                        {
                            ID = new Guid("b3ab6782-6c72-4861-a37c-153f7a7ae72f"),
                            NameAr = "ضيافة",
                            NameEn = "Hospitality"
                        },
                        new
                        {
                            ID = new Guid("06620dc1-4f7b-480d-8975-396b0d9f39f4"),
                            NameAr = "العقارات",
                            NameEn = "Real estate"
                        },
                        new
                        {
                            ID = new Guid("82147460-45dd-4e85-b505-3247ceb28dc2"),
                            NameAr = "الرياضة",
                            NameEn = "Sports"
                        },
                        new
                        {
                            ID = new Guid("7445c5dd-fc84-4968-b771-0d2093b9bd6c"),
                            NameAr = "البناء",
                            NameEn = "Construction"
                        },
                        new
                        {
                            ID = new Guid("b908aef5-c7d0-493c-99c4-0e089a9d745b"),
                            NameAr = "خدمات أخرى",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "65cbbe40-89ac-4174-9c2f-5944cf5bdabe",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "c55cb2cf-621a-475e-a803-81a8360195c2",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "c706ff24-c574-4dfd-9089-a11a4babd219",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = "4e3a7a88-6b7f-462f-b36a-788537e75cd6",
